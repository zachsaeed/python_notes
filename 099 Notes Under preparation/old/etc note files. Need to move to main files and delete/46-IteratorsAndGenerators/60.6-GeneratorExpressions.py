# TODO after list comprehensions
# - You ca also create generators from generator expressions
# - What list comprehensions are to lists generator expressions
#   are to generators so they look like list comprehensions
